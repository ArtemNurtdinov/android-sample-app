...
open class BaseViewModel : ViewModel() {
    ...
    private val _errorWithTitleLiveData = MutableLiveData<Event<DialogPayload>>()
    val errorWithTitleLiveData: LiveData<Event<DialogPayload>> = _errorWithTitleLiveData
